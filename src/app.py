...
activities = {
    ...
    "Drama Club": {
        "description": "Theater production, acting, and stage design",
    ...
    "Robotics Club": {
        ...
        "max_participants": 25,
        "participants": ["ryan@mergington.edu", "asian@mergington.edu"]
    },
    "Debate Team": {
...
def unregister_from_activity(activity_name: str, email: str):
    ...
    # Validate if the student is currently signed up
